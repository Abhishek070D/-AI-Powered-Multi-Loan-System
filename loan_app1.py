...
.kpi-card {
    flex:1; background:#F5F5F5; border-radius:14px;
...
/* ── Condition check box ── */
.cond-wrap {
    background:#F5F5F5; border:1px solid #E2EAF4; border-radius:14px;
...
def show_result(is_app,prob,app_amt,int_rate,t_months,
    ...
    <div class="res-big" style="color:black;">✅ LOAN APPROVED!</div>
    <div class="res-sub" style="color:rgba(255,255,255,.78);">
...
def home_page():
    ...
    ax.set_title("Monthly Income (₹K)",color="#0A1A86",fontsize=10,fontweight='bold')
    ax.legend(fontsize=7,facecolor='#1E2F45',edgecolor='none',labelcolor='#DDE8F5'); ax.grid(True,alpha=.3)
...
# ──────────────────────────────────────────────────────────────
st.markdown('<hr class="dv">',unsafe_allow_html=True)
st.markdown("""<div style="text-align:center;color:black;font-size:.76rem;padding:6px 0 16px;">
